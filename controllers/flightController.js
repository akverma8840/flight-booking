...
exports.createFlight = async (req, res, next) => {
  ...
  try {
    ...
    const f = await Flight.create({ airlineId, flightNumber, origin, destination, departureTime: departureAt, arrivalTime: arrivalAt, totalSeats, availableSeats: totalSeats, price });
...
exports.searchFlights = async (req, res, next) => {
  try {
    ...
    if (date) {
      where.departureTime = { [Op.between]: [new Date(date+'T00:00:00'), new Date(date+'T23:59:59')] };
    }
